                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-3">
                        ...
                        <input name="domain_name" value={form.domain_name || ''} onChange={handleChange}
                            className="w-full bg-slate-50 border border-slate-100 rounded-[20px] py-4 px-6 text-slate-950 font-black outline-none focus:ring-4 focus:ring-orange-500/10" />
                    </div>
